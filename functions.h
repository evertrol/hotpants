...
void buildStamps(int, int, int, int, int *, int *, int, int, int, stamp_struct *, stamp_struct *, float *, float *,
                 float, float);
...
double checkPsfCenter(float *, int, int, int, int, int, int, double, float, float, int, int, int, int);
...
int getStampStats3(float *, int, int, int, int, double *, double *, double *, double *, double *, double *, double *,
                   int, int, int);
...
int hp_fits_write_subset(fitsfile *, long, long, long *, float *, int *, int, float, float, int, int, int, int, int,
                         int);
int hp_fits_write_subset_int(fitsfile *, long, long, long *, int *, int *, int, float, float, int, int, int, int, int,
                             int);
